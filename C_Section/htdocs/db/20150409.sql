...
--
ALTER TABLE `board`
  MODIFY `idx` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=54;

--
-- 테이블의 AUTO_INCREMENT `ep`
--
ALTER TABLE `ep`
  MODIFY `idx` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- 테이블의 AUTO_INCREMENT `ep_list`
--
ALTER TABLE `ep_list`
  MODIFY `idx` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
