...
export default function Local2015() {
  const task4Url = "http://2015-local.134.185.111.209.nip.io/";

  return (
    <section className="container max-w-5xl py-8 sm:py-12">
      <Helmet>
        <title>2015 지방기능경기대회 | WebSkills Archive</title>
        <meta
          name="description"
          content="2015 지방기능경기대회 과제 결과물 페이지"
        />
      </Helmet>
      ...
      <div className="bg-surface shadow-soft mt-8 rounded-4xl border border-black/5 p-7 sm:p-10">
        <div className="mb-4 flex items-center gap-3">
          ...
          <span className="text-muted text-sm font-medium">2015 Gwangju</span>
        </div>

        <h1 className="text-head text-3xl font-extrabold tracking-tight sm:text-4xl">
          2015 지방기능경기대회 과제 결과물
        </h1>
