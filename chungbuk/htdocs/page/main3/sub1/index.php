<form id="rsv_frm" action="/page/main3/sub1/rsv_ok.php" method="post" onSubmit="return rsvSubmit(this);">
    <div>
        ...
        <input type="hidden" id="rsv_userid" name="userid" value="<?php if(isset($_SESSION['userid'])) echo $_SESSION['userid']; ?>">
    </div>
    <div id="main3sub1">
        <div class="after">
        	<div>
...
function rsvSubmit(frm){
	...
	for(var key in arr){
		arr[key] = arr[key] + "l" + $("#drop").find("[data-menu='"+arr[key]+"']").length;
	}
