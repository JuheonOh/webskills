	...
	<div class="login_box">
    	...
    	<form id="login_frm" action="/" method="post" onSubmit="return frmChk(this, 'userid', 'pw');">
            ...
            <ul class="login_box_area">
            	<li><input type="text" name="userid" id="userid" title="userid" value=""  placeholder="User ID"></li>
                <li><input type="password" name="pw" id="pw" title="pw" value=""  placeholder="Password"></li>
            </ul>
