...
function photos() {
  ...
  $('#photos img').click(function () {
    ...
    var img =
      ...
      '" title="' +
      src +
      '" style="width:640px; height:426px; opacity:0;" />'
...
function readmore() {
  ...
  $('.hidden-text')
    .prev()
    .append(
      "<button class='moreBtn' style='float:left; width:100%; height:50px;'>read more</button>",
    )
...
// Result
function result() {
  $('#result > div > div:nth-child(2) > ul > li > ul > li:nth-child(3)').attr(
    'data-photo',
    'medaillist-2013-3.jpg',
  )
...
function animation(type) {
  ...
  var left = -100 * cut + '%'
  $('#slider > div > div:nth-child(2) > ul')
    .stop()
    .animate({ 'margin-left': left }, 1500)
}
...
$(function () {
  ...
  $('#slider > div > div:nth-child(1)').css({
    'border-top': '30px solid transparent',
    'border-bottom': '30px solid transparent',
    'border-right': '35px solid #09f',
    width: 0,
    height: 0,
  })
  $('#slider > div > div:nth-child(3)').css({
    'border-top': '30px solid transparent',
    'border-bottom': '30px solid transparent',
    'border-left': '35px solid #09f',
    width: 0,
    height: 0,
  })
